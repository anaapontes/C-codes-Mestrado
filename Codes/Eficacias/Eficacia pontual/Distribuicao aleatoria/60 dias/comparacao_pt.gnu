...
set output "comparacao-pt-350-60d-oficial.pdf"                         	       	       # Define o nome do arquivo de saída
...
set ylabel "{/*1.1{J}_{p}}"                                   # Rótulo do eixo y
...
plot "eficacia_pt_w_libvirgem_virgem-60d-oficial.dat" u 1:2 w linespoints ls 5 pt 7 title 'Wolbachia - Virgem', \
     "eficacia_pt_w_libvirgem_nvirgem-60d-oficial.dat" u 1:2 w linespoints ls 11 pt 7 title 'Wolbachia - Não virgem', \
     "eficacia_pt_m_libvirgem_virgem-60d-oficial.dat" u 1:2 w linespoints ls 13 pt 7 title 'Estéreis - Virgem', \
     "eficacia_pt_m_libvirgem_nvirgem-60d-oficial.dat" u 1:2 w linespoints ls 12 pt 7 title 'Estéreis - Não virgem'
