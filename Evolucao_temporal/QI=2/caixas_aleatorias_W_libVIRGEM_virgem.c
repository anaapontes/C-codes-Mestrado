...
#define TFIM2 (TFIM+365)         // Tempo final, após 30 dias sem liberação
...
int main() {
    ...
    double QI,xe,J,dinU[TFIM2], dinI[TFIM2];
    FILE *ar;

    // Abre o arquivo para escrita
    ar = fopen("TEMPO_w_libVIRGEM_virgem-QI=2.dat", "w");

    QI=2;//proporcao de infectados com relacao a nao infectados
    NC=350;// numero de criadouros  
        ...
        for (n = 0; n < MEDIA; n++) {
            ...
            for (i = 0, j = 0; i < TEQ; i++) {
                ...
                for (k = 0,nU = 0,nI = 0; k < LR2; k++) {
	                ...
	                else if ( PT[k] == 4) nI++; // só VIRGEM infectado
                }
